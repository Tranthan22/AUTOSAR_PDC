...
extern FUNC(Std_ReturnType, RTE_CODE_EcucPartition_0) Rte_Read_ParkDistanceControl_R_RP_DistanceUS_ReadDistanceUS( VAR(ParkDistanceControl_uint8, AUTOMATIC, RTE_APPL_DATA) distanceUS );
#define Rte_Read_R_RP_DistanceUS_ReadDistanceUS Rte_Read_ParkDistanceControl_R_RP_DistanceUS_ReadDistanceUS 
